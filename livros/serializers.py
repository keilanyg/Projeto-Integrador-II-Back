...
from livros.models import Autor, Categoria, Devolucao, Editora, Emprestimo, Livro
...
class EmprestimosSerializer(serializers.ModelSerializer):
    ...
    nome_emprestado_usuario_obj = serializers.SerializerMethodField(
        "show_nome_emprestado_usuario"
    )
    ...
    class Meta:
        ...
        fields = [
            "id",
            "nome_emprestado_usuario",
            "livro",
            "data_emprestimo",
            "livro_obj",
            "nome_emprestado_usuario_obj",
        ]
    ...
    def show_nome_emprestado_usuario(self, instance):
        nome_emprestado_usuario = User.objects.get(
            id=instance.nome_emprestado_usuario.id
        )
